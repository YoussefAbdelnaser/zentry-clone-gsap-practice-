    ...
    <div id="contact" className="my-20 min-h-96 w-screen px-10">
      <div className="relative rounded-lg py-24 bg-black text-blue-50 sm:overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center">
          <p className="font-general text-[12px] uppercase">Become a Darkin</p>
          <p className="special-font mt-10 w-full font-zentry text-5xl leading-0.9 md:text-[6rem] z-20">
            Lets <br />
            destroy the <br /> world
          </p>
          <Button title="Destroy" containerClass="mt-10" />
        </div>
      </div>
    </div>
  );
